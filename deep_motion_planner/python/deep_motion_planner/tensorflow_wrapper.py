...
class TensorflowWrapper():
  ...
  """
  def __init__(self, storage_path, protobuf_file='graph.pb', use_checkpoints=False, use_stochastic_policy=False, input_dimension=38):
...
#         if filename_weights == None:
    ...
    self.use_stochastic_policy = use_stochastic_policy
...
#       feed_dict = {'data_input:0': [data]}
      ...
      tv = np.maximum(-0.0, prediction[0,0] + np.random.normal(0, std_trans))

      rv = prediction[0,1] + np.random.normal(0, std_rot)
